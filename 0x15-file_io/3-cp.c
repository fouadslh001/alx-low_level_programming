...
/**
 * _error - function for Read our file.
 * @e: Error number will get
 * @filename: the File name of our file
 */
...
/**
 * main - the main programe will Copies the content of a file to another file.
 * @ac: Argument we need for count
 * @av: argument values we will enter
 * Return: 0 on succes, -1 on error or fail the prcesse.
 */
